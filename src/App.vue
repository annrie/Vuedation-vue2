        ...
        <div class="cell shrink">
          ...
          <div class="back-to-top-sticky hide-for-print" data-sticky-container>
            <div
              ...
              data-sticky-on="small"
              data-top-anchor="content-top:top"
              data-btm-anchor="footer:top"
              data-margin-bottom="0"
            >
              <div class="grid-container">
                <div class="back-to-top-grid grid-x align-right">
                  <a v-scroll-to="'#main'" to="#">
                    <span
            ...
            <!-- <div class="back_to_top">
              <a v-scroll-to="'#mainNav'" href="#" data-smooth-scroll>
                <svg class="icon">
                ...
                <img
                  ...
                  width="34px"
                  height="34px"
                  src="ikonate/icons/chevrons-up.svg"
                />
                <fa-icon icon="fa-arrow-circle-up" size="4x" />
                <span>トップへ戻る</span>
              </a>
            </div> -->
            <aside class="back_to_top">
              <a href="#main" data-smooth-scroll>
                <i class="fas fa-arrow-circle-up fa-3x"></i>
                <span>トップへ戻る</span>
              </a>
            </aside>
            <!-- <aside class="back_to_top">
              <a v-scroll-to="'#main'" href="#" data-smooth-scroll>
            ...
            <footer id="footer" class="footer">
              <div class="section-spacing">
                <div class="grid-container">
                  <div
                    class="grid-x grid-padding-x grid-padding-y align-center-middle"
                  >
